...
public class UserTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(um2.searchByName("김")));
		System.out.println(Arrays.toString(um2.getUsers()));
		System.out.println(um2.getAgeAvg());
		
		// UserManager 2개가 같은 인스턴스를 참조하는지 검사
		System.out.println(um.getUsers()[0].getName().equals(um2.getUsers()[0].getName()));
